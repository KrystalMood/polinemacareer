      ...
      <div className="max-w-7xl mx-auto py-12">
        <div className="flex items-center justify-between max-w-[80vw]">
          <div className="space-y-2">
            <h1 className="font-semibold text-2xl md:text-3xl leading-[1.2] tracking-tight text-gray-900">
              Top Companies
            </h1>
            <p className="text-base md:text-lg text-gray-600 leading-[1.6] max-w-xl font-normal">
              Discover the leading companies shaping the future of work and creativity.
            </p>
          </div>
          <div className="flex text-sky-600">
            <button 
              onClick={() => router.push("/main/companies")}
              className="rounded-lg bg-blue-50 flex items-center font-medium text-sm md:text-base px-4 py-2 hover:bg-blue-100 transition-colors duration-300"
            >
              View all companies
          ...
          {companies.map((company) => (
            ...
            >
              <div className="flex space-x-3 items-center">
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    {company.isFeatured && (
                      <span className="text-xs px-2 py-1 rounded-full bg-[#f1c2c2] text-[#E05151] font-medium">
                        Excellent
                      </span>
                    )}
                  </div>
              ...
              <button
                ...
                className="mt-6 w-full items-center font-medium text-sm md:text-base text-gray-900 bg-blue-50 rounded-lg py-2 group-hover:bg-yellow-300 group-hover:text-white transition-all duration-300"
              >
                View job
              </button>
            </div>
