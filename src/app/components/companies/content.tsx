      ...
      <div className="mx-auto w-[90vw] max-w-7xl py-16">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex-1">
                <select 
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#ff9b71] 
                  focus:ring-2 focus:ring-[#ff9b71]/20 outline-none transition-all"
                >
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-72 space-y-6">
            {/* Location Radius */}
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Location Radius</h3>
              <input
                type="range"
                min="0"
                max="100"
                ...
                className="w-full accent-[#ff9b71]"
              />
              <div className="text-sm text-gray-600 mt-2">Within {radius} miles</div>
            </div>
